...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    double time_spent = (stop_time-start_time)/125000000.0; // change obviously
    double throughput = (bytes_transferred/time_spent)/1000000;
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 10 Levi Fleming- Custom Peripheral Demonstration\n\r");
